  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white px-6 dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="flex-1 max-w-md">
        <div
          className={cn(
            "flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 transition-all dark:border-slate-700 dark:bg-slate-800",
            searchFocused &&
              "border-indigo-400 ring-2 ring-indigo-100 dark:border-indigo-500 dark:ring-indigo-900/30"
          )}
        >
          ...
          <input
            ...
            className="w-full bg-transparent text-sm text-slate-700 outline-none placeholder:text-slate-400 dark:text-slate-300"
